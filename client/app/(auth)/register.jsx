...
/**
 * The registration screen for creating a new user account.
 * @returns {JSX.Element} The registration screen component.
 */
const RegisterScreen = () => {
  ...
  const handleRegister = useCallback(async () => {
    ...
    try {
      ...
      setSuccessMessage(t('success') + ': ' + ERROR_MESSAGES.REGISTRATION_SUCCESS);
      setToastVisible(true);
      setTimeout(() => {
      ...
      <View style={[styles.container, { backgroundColor: isDarkMode ? SCREEN.BACKGROUND_COLOR_DARK : SCREEN.BACKGROUND_COLOR_LIGHT }]}>
        ...
        <ScrollView contentContainerStyle={styles.scrollContent}>
          <View style={[styles.formContainer, { backgroundColor: isDarkMode ? FORM.BACKGROUND_COLOR_DARK : FORM.BACKGROUND_COLOR_LIGHT }]}>
            <Text style={[styles.title, { color: isDarkMode ? FORM.TITLE_COLOR_DARK : FORM.TITLE_COLOR_LIGHT }]}>{t('register')}</Text>
